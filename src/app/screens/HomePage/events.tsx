            ...
            <Container sx={{ overflow: "hidden" }}>
                <Stack className={"events_main"}>
                    ...
                    <Box className={"prev_next_frame"} sx={{ color: "black" }}>
                        <img src={"/icons/arrow-left.svg"} className={"swiper-button-prev"} />
                        <div className={"dot_frame_pagination swiper-pagination"}></div>
                        <img src={"/icons/arrow-right.svg"} className={"swiper-button-next"} />
                    </Box>
                    <Swiper
                                            ...
                                            <Box className={"bott_left"}>
                                                <div className={"event_title_speaker"}>
                                                    ...
                                                    <div className={"event_organizator"}>
                                                        <img src={"/home/profile.4.png"} style={{ width: "20px", marginRight: "10px" }} />
                                                ...
                                                <div className={"bott_info"} style={{ marginTop: "10px", flexDirection: "row" }}>
                                                    <div className={"bott_info_main"}>
                                                        <img src={"/icons/bed.svg"} style={{ marginRight: "10px" }} />
                                                        {/*{value.date}*/} 4
                                                    </div>

                                                    <div className={"bott_info_main"}>
                                                        <img src={"/icons/bath.svg"} style={{ marginRight: "10px" }} />
                                                        {/*{value.date}*/} 2
                                                    </div>
                                                    <div className={"bott_info_main"}>
                                                        <img src={"/icons/kv.svg"} style={{ marginRight: "10px" }} />
                                                        {/*{event?.event_status} 70 m2*/}
                                                    </div>
                                                    <div className={"bott_info_main"}>
                                                        <img src={"/icons/location.svg"} style={{ marginRight: "10px" }} />
